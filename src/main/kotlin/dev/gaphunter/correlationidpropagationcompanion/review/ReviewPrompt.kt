package dev.gaphunter.correlationidpropagationcompanion.review
...
object ReviewPrompt {
    ...
    private const val KEY_SEEN_FINDINGS = "dev.gaphunter.correlationidpropagationcompanion.review.seenFindings"
    private const val KEY_ANSWERED = "dev.gaphunter.correlationidpropagationcompanion.review.answered"

    private const val NOTIFICATION_GROUP_ID = "Correlation ID Propagation Companion"

    // Marketplace listing (real ID resolved after first publish).
    private const val MARKETPLACE_URL = "https://plugins.jetbrains.com/plugin/33795-correlation-id-propagation-companion/reviews"
